...
const getRandomUsername = () => {
  ...
  if (useShortName) {
    ...
    return `${randomAdjective[0].toUpperCase() + randomAdjective.slice(1)} ${randomShortAnimal[0].toUpperCase() + randomShortAnimal.slice(1)
      }`
  } else {
    ...
    return `${randomShortAdjective[0].toUpperCase() + randomShortAdjective.slice(1)} ${randomAnimal[0].toUpperCase() + randomAnimal.slice(1)
      }`
  }
}
