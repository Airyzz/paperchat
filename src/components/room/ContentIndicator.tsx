    ...
    return indicatorKeys.map((id) => {
      ...
      return (
        <div
          ...
          className={`${indicator} ${id.includes('paperchat_octagon') ? skip_animation : ''} ${ind.isVisible ? '' : invisible
            } ${ind.isOverflowedIndicator1 && !ind.isVisible ? overflowed_1 : ''} ${ind.isOverflowedIndicator2 && !ind.isVisible ? overflowed_2 : ''
            }`}
        ></div>
      )
    })
